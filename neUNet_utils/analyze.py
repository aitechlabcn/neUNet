...
if __name__ == "__main__":
    labels = {'Synapse': ['spleen', 'rkid', 'lkid', 'gall', 'liver', 'sto', 'aorta', 'pancreas']}
    test_A = Analyze(
        image_path=r"/home/usr/yangweibin/nnunetv2/nnUNet/DATASET/nnUNet_raw/Dataset099_Synapse/imagesTr",
        predict_path=r"/home/usr/yangweibin/nnunetv2/nnUNet/DATASET/nnUNet_results/Dataset099_Synapse/nnUNetTrainer__nnUNetPlans__3d_fullres/result/fold_4/validation",
        label_path=r"/home/usr/yangweibin/nnunetv2/nnUNet/DATASET/nnUNet_preprocessed/Dataset099_Synapse/gt_segmentations/",
        dataset_json=r"/home/usr/yangweibin/nnunetv2/nnUNet/DATASET/nnUNet_preprocessed/Dataset099_Synapse/dataset.json",
        save_path=r"/home/usr/xulongwei/nnunet-ai-tech-lab/results/test_analyze",
        ref_name="Synapse",
        labels=labels['Synapse'])
    test_A.compute_metrics(metrics=['dice', 'HD95'])
