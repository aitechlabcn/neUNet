...
def convert_predicted_logits_to_segmentation_with_correct_shape(predicted_logits: Union[torch.Tensor, np.ndarray],
    ...
    predicted_logits = configuration_manager.resampling_fn_probabilities(predicted_logits,
                                            ...
                                            current_spacing,
                                            properties_dict['spacing'])    # 裁剪后图像重采样回原始spacing
    ...
    predicted_probabilities = label_manager.apply_inference_nonlin(predicted_logits)   # softmax处理
    del predicted_logits
    segmentation = label_manager.convert_probabilities_to_segmentation(predicted_probabilities)    # 分割结果
    ...
    segmentation_reverted_cropping[slicer] = segmentation    # 恢复到裁剪前原图尺寸
    del segmentation
    ...
    if return_probabilities:
        ...
        predicted_probabilities = predicted_probabilities.cpu().numpy()    # 概率图恢复裁剪前原图尺寸
        # revert transpose
